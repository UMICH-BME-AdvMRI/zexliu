...
% Some note: This function calculates the steady-state signal at TE for
% repeated excitations given T1, T2, TR, TE in ms. dfreq is the resonant
% frequency in Hz. flip is in radians. phi is the phase twist at the end of
% the sequence
